...
public class tokenizeStopStem{
	...
	public static void main(String args[]) {
		...
		System.out.println("Stringa elaborata:"+k.output(s));
	}
	...
	public String output(String input) {
		...
		Collection<String> c = new ArrayList<String>() {
			{
		        ...
		        add("likely");
		        add("little");
		        add("ll"); // added to avoid words like you'll,I'll et
		        add("look");
		        add("looking");
		        add("looks");
		        add("ltd");
		        ...
		        add("value");
		        add("various");
		        add("ve"); // added to avoid words like I've,you've et
		        add("very");
		        add("via");
		        add("viz");
		        add("vs");
        ...
        //System.out.println("Stop word set creato:");
